...
| [extract-iefe-no-captures](https://raw.githubusercontent.com/JayBazuzi/RoslynRefactor/refs/heads/main/Tests/_approvals/RoslynRefactorRootCommandTests.ApproveHelpText.extract-iefe-no-captures.approved.md) | (PREVIEW) Wrap a capture-free selection (statements or an expression) in an immediately-invoked static lambda. Would-be captures are instead passed in or returned. |
| [extract-interface](https://raw.githubusercontent.com/JayBazuzi/RoslynRefactor/refs/heads/main/Tests/_approvals/RoslynRefactorRootCommandTests.ApproveHelpText.extract-interface.approved.md) | Extract the public members of a class/struct/interface into a new interface, in a new file |
...
| [make-method-static](https://raw.githubusercontent.com/JayBazuzi/RoslynRefactor/refs/heads/main/Tests/_approvals/RoslynRefactorRootCommandTests.ApproveHelpText.make-method-static.approved.md) | Convert an instance method into a static method by adding a parameter for its receiver, and update all call sites |
...
| [reorder-parameters](https://raw.githubusercontent.com/JayBazuzi/RoslynRefactor/refs/heads/main/Tests/_approvals/RoslynRefactorRootCommandTests.ApproveHelpText.reorder-parameters.approved.md) | Reorder a method/property/indexer/delegate's parameters and update all call sites |
<!-- endInclude -->
