...
sealed class RenameCommand : ICommand
{
    ...
    static async Task<int> RunAsync(string projectPath, string filePath, int line, int column, string newName, TextWriter output, CancellationToken cancellationToken)
    {
